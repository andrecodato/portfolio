...
---
# Atividade 1 <span className='text-codato-neon'>-</span> Primeiro html com pesquisa<span className='text-codato-neon'>!</span> <br/><span className='text-codato-neon'>Valor:</span> 0,5 Pontos
...
<iframe src="/htmls/002/index.html" title="Atividade do dia - Desenvolvimento para Internet #002" width="100%" height="500px" style={{ border: "none", margin: "24px 0" }}></iframe>
